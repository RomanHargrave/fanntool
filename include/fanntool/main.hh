...
#include <fanntool/data_process.hh>
#include <FL/fl_ask.H>
...
public:
  ...
  Fl_Choice *WLabel;
private:
  inline void cb_WLabel_i(Fl_Choice*, void*);
...
public:
  ...
  Fl_Counter *nOutput;
private:
  inline void cb_nOutput_i(Fl_Counter*, void*);
  static void cb_nOutput(Fl_Counter*, void*);
public:
  Fl_Button *Wbt;
private:
  inline void cb_Wbt_i(Fl_Button*, void*);
  static void cb_Wbt(Fl_Button*, void*);
public:
  Fl_Value_Slider *rTrain;
private:
  inline void cb_rTrain_i(Fl_Value_Slider*, void*);
  static void cb_rTrain(Fl_Value_Slider*, void*);
public:
  Fl_Value_Slider *rTest;
private:
  inline void cb_rTest_i(Fl_Value_Slider*, void*);
...
public:
  ...
  Fl_Counter *nInput;
private:
  inline void cb_nInput_i(Fl_Counter*, void*);
  static void cb_nInput(Fl_Counter*, void*);
public:
  Fl_Button *Wbt;
private:
  inline void cb_Wbt1_i(Fl_Button*, void*);
  static void cb_Wbt1(Fl_Button*, void*);
public:
  Fl_Value_Slider *rTrain;
private:
  inline void cb_rTrain1_i(Fl_Value_Slider*, void*);
  static void cb_rTrain1(Fl_Value_Slider*, void*);
public:
  Fl_Value_Slider *rTest;
private:
  inline void cb_rTest1_i(Fl_Value_Slider*, void*);
  static void cb_rTest1(Fl_Value_Slider*, void*);
public:
  Fl_Check_Button *Shuffle;
private:
  inline void cb_Shuffle_i(Fl_Check_Button*, void*);
  static void cb_Shuffle(Fl_Check_Button*, void*);
public:
  Fl_Input *fName;
  Fl_Check_Button *Scale_D;
private:
  inline void cb_Scale_D_i(Fl_Check_Button*, void*);
  static void cb_Scale_D(Fl_Check_Button*, void*);
public:
  Fl_Group *Gr;
  Fl_Value_Input *Min;
private:
  inline void cb_Min1_i(Fl_Value_Input*, void*);
  static void cb_Min1(Fl_Value_Input*, void*);
public:
  Fl_Value_Input *Max;
private:
  inline void cb_Max1_i(Fl_Value_Input*, void*);
  static void cb_Max1(Fl_Value_Input*, void*);
public:
  Fl_Chart *Chart;
  Fl_Value_Slider *MinV;
private:
  inline void cb_MinV1_i(Fl_Value_Slider*, void*);
  static void cb_MinV1(Fl_Value_Slider*, void*);
public:
  Fl_Value_Slider *MaxV;
private:
  inline void cb_MaxV1_i(Fl_Value_Slider*, void*);
  static void cb_MaxV1(Fl_Value_Slider*, void*);
public:
  Fl_Light_Button *Hist;
private:
  inline void cb_Hist_i(Fl_Light_Button*, void*);
